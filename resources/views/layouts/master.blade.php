      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item">
            <router-link to="/employees" class="nav-link"  active-class="active" exact>
              ...
              <li class="nav-item">
              <router-link to="/departments" class="nav-link"  active-class="active" exact>
              ...
              <li class="nav-item">
              <router-link to="/positions" class="nav-link"  active-class="active" exact>
              <i class="nav-icon fas fa-address-card blue"></i>
                  <p>
                      Positions
                  </p>
              </router-link>
              ...
              <li class="nav-item">
              <router-link to="/checkIns" class="nav-link"  active-class="active" exact>
              ...
              <li class="nav-item">
              <router-link to="/checkOuts" class="nav-link"  active-class="active" exact>
              <i class="nav-icon fas fa-user-clock purple"></i>
                  <p>
                      Time Out Rules
                  </p>
              </router-link>
